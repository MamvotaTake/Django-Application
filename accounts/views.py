        ...
        if user is not None:
            try:
                ...
                if is_cart_item_exists:
                    ...
                    # Get cart items from the user to access it's product variations
            ...
            messages.success(request, 'You have now login!')
...
def reset_password_validate(request, uidb64, token):
    ...
    if user is not None and default_token_generator.check_token(user, token):
        ...
        messages.error(request, 'This linked has expired!')
        return redirect('login')
