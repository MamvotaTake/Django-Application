...
def payments(request):
    ...
    mail_subject = "We have just received your order. Thank you for ordering with us!. Вам Удачи ❤❤!"
...
def place_order(request, total=0, quantity=0):
    ...
    carts_items = CartItem.objects.filter(user=current_user)
    cart_count = carts_items.count()
    if cart_count <= 0:
